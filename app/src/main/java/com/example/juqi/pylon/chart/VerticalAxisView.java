...
public class VerticalAxisView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(coordinateX, startCoordinateY, coordinateX, calculator.yAxisDrawHeight, paint);
        //canvas.drawLine(calculator.xAxisWidth, startCoordinateY, calculator.xAxisWidth, calculator.yAxisDrawHeight, paint);
