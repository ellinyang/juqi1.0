...
public class BesselChart extends LinearLayout {
    ...
    private void init() {
        ...
        } else if(position == VerticalAxisView.POSITION_RIGHT){
            besselChartLayout.addView(besselChartView, 0, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT, 1));
        } else if(position == VerticalAxisView.POSITION_BOTH){
            besselChartLayout.addView(besselChartView, 1, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT, 1));
        }
